...
func createListRepoUpdateJobsQuery(opts ListRepoUpdateJobOpts) *sqlf.Query {
	...
	return sqlf.Sprintf(listRepoUpdateJobsFmtstr, sqlf.Join(RepoCloneJobColumns, ", "), sqlf.Join(preds, ", "))
}
...
// RepoCloneJobColumns is a set of columns which are in the `repo_update_jobs`
// table.
